...
def train(opt):
    ...
    if opt.model=='pointnet++':
     ...
     #torch.load(net, '/content/Point-Cloud-Classification-demo/save_models/PointNet++.pkl') #os.path.join(opt.model_save_path,save_net_file))
    if opt.c > 0:
      print('continue training')
      net.load_state_dict(torch.load(os.path.join(opt.model_save_path,save_net_file)))
    ...
    for epoch in range(opt.nepoch):
        ...
        # net.load_state_dict(torch.load(os.path.join(opt.model_save_path,save_net_file)))
        torch.save(net.state_dict(), os.path.join(opt.model_save_path,save_net_file))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='/content/Point-Cloud-Classification-demo/modelnet40_normal_resampled',#'/home/poley/Work_Space/Dataset/modelnet40_normal_resampled',
    ...
    parser.add_argument('--model_save_path', type=str, default='/content/drive/MyDrive/Models/PointNet-pytorch/model_data', help='model save path')
